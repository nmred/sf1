...
namespace swan\controller\action\helper;
use swan\controller\action\helper\exception\sw_exception;
...
abstract class sw_abstract
{
	 ...
	 */
	public function set_action_controller(\swan\controller\sw_action $action_controller)
	{
