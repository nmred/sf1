...
use swan\controller\action\sw_broker_stack;
use swan\controller\action\exception\sw_exception;
...
class sw_broker
{
	 ...
	 * __construct 
	 * 
	 * @param \swan\controller\sw_action $action_controller 
	 * @access public
	 * @return void
	 */
	public function __construct(\swan\controller\sw_action $action_controller)
	{
	 ...
	 * 添加助手 
	 * 
	 * @param \swan\controller\action\helper\sw_abstract $helper 
	 * @static
	 * @access public
	 * @return void
	 */
	public static function add_helper(\swan\controller\action\helper\sw_abstract $helper)
	{
	 ...
	 * @param string $name 
	 * @access public
	 * @return \swan\controller\action\helper\sw_abstract
	 */
	 ...
	 * 
	 * @access public
	 * @return \swan\controller\action\sw_broker_stack
	 */
	public static function get_stack()
	{
	...
	protected static function _load_helper($name)
	{
		...
		if (!($helper instanceof \swan\controller\action\helper\sw_abstract)) {
			throw new sw_exception('Helper name ' . $name . ' -> class ' . $full_class . ' is not of type \swan\controller\action\helper\sw_abstract');
		}
