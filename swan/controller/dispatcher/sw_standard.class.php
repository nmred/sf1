...
class sw_standard extends sw_abstract
{
	 ...
	 * @param string $module
	 * @access public
	 * @return swan\controller\dispatcher\sw_standard
	 */
	 ...
	 * @return string
	 */
	public function get_controller_class(\swan\controller\request\sw_abstract $request)
	{
	 ...
	 * @return string
	 */
	public function get_action_method(\swan\controller\request\sw_abstract $request)
	{
	...
	public function dispatch(\swan\controller\request\sw_abstract $request, \swan\controller\response\sw_abstract $response)
	{
		...
		if (!$controller instanceof \swan\controller\sw_action) {
			throw new sw_exception("Controller '$class_name' is not an instance of \swan\controller\sw_action");	
		}
