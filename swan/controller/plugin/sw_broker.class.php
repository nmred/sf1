...
class sw_broker extends sw_abstract
{
	 ...
	 * @access public
	 * @return swan\controller\plugin\sw_broker
	 */
	 ...
	 * 注销一个插件 
	 * 
	 * @param \swan\controller\plugin\sw_abstract|string $plugin 
	 * @access public
	 * @return \swan\controller\plugin\sw_broker
	 */
	public function unregister_plugin($plugin)
	{
		if ($plugin instanceof \swan\controller\plugin\sw_abstract) {
	 ...
	 * @return void
	 */
	public function dispatch_loop_shutdown(\swan\controller\request\sw_abstract $request = null)
	{
		foreach ($this->__plugins as $plugin) {
			try {
