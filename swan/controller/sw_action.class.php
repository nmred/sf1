...
use swan\controller\action\sw_interface;
...
abstract class sw_action implements sw_interface
{
	 ...
	 * 动作助手经纪人 
	 * 
	 * @var \swan\controller\action\sw_broker
	 * @access protected
	 */
	 ...
	 * @return void
	 */
	public function __construct(\swan\controller\request\sw_abstract $request, \swan\controller\response\sw_abstract $response, array $invoke_args = array())
	{
		$this->set_request($request)
			 ->set_response($response)
			 ->_set_invoke_args($invoke_args);
		
		$this->__helper = new \swan\controller\action\sw_broker($this);	
		$this->init();
	}
	 ...
	 * @param \swan\controller\request\sw_abstract $request 
	 * @access public
	 * @return \swan\controller\sw_action
	 */
	 ...
	 * 设置前端控制器 
	 * 
	 * @param \swan\controller\sw_controller $controller 
	 * @access public
	 * @return \swan\controller\sw_action
	 */
	public function set_controller(\swan\controller\sw_controller $controller)
	{
	...
	public function get_controller()
	{
		...
		if (class_exists('\swan\controller\sw_controller')) {
