...
namespace swan\db\select;
use swan\db\adapter\sw_abstract;
...
class sw_select
{
	 ...
	 * __construct
	 *
	 * @param \swan\db\adapter\sw_abstract $adapter
	 * @access public
	 * @return void
	 */
	public function __construct(\swan\db\adapter\sw_abstract $adapter)
	{
	 ...
	 * 处理查询的字段
	 *
	 * @param array|string|\swan\db\sw_db_expr $cols
	 * @param string $correlation_name
	 * @access public
	 * @throws swan\db\select\exception\sw_exception
	 * @return \swan\db\select\sw_select
	 */
	 ...
	 * 装饰 FROM 子句
	 *
	 * @param array|string|\swan\db\sw_db_expr $name
	 * @param array|string|\swan\db\sw_db_expr $cols
	 * @param string $schema
	 * @access public
	 * @return \swan\db\select\sw_select
	 ...
	 * 装饰 UNION 子句
	 *
	 * @param array $select 数组中的元素是 SQL 语句或 \swan\db\select\sw_select 对象
	 * @param string $type
	 * @access public
	 * @throws swan\db\select\exception\sw_exception
	 * @return \swan\db\select\sw_select
	 ...
	 * @param array $bind 
	 * @access public
	 * @return PDO_Statement|\swan\statement\sw_standard
	 */
	...
	/**
	 * 获取 \swan\db\adapter\sw_abstract
	 *
	 * @access public
	 * @return void
	 */
	 ...
	 * @param array|string|\swan\db\sw_db_expr $name 指定表名
