...
namespace swan\db\profiler;
use swan\db\profiler\sw_profiler_query as sw_profiler_query;
use swan\db\profiler\exception\sw_exception as sw_exception;
...
class sw_profiler
{
	...
	/**
	 * 存储swan\db\profiler\sw_profiler_query 对象 
	 * 
	 * @var array
	 * @access protected
	 */
	 ...
	 * 
	 * @param swan\db\profiler\sw_profiler_query $query 
	 * @access public
	 * @return integer 
	 */
	 ...
	 * @access public
	 * @throws swan\db\profiler\exception\sw_exception 
	 * @return swan\db\profiler\sw_profiler_query
	 */
