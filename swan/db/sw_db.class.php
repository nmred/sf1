...
namespace swan\db;
use swan\db\exception\sw_exception;
...
class sw_db
{
	...
	public static function factory($type = null, array $options = array())
	{
		...
		$class_name = 'swan\db\adapter\sw_' . $type;
	...
	public static function singleton($db_type = null, array $options = array())
	{
		...
		if (isset(self::$__db[$db_type]) && self::$__db[$db_type] instanceof swan\db\adapter\sw_abstract) {
