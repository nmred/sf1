...
use \swan\validate\sw_interface;
...
class sw_abstract implements sw_interface
{
	...
	public function set_message($message_string, $message_key = null)
	{
		...
		if (!isset($this->__message_templates[$message_key])) {
			throw new sw_exception("No message template exists for key '$message_key'");
		}
	...
	public function __get($property)
	{
		...
		throw new sw_exception("No property exists by the name '$property'");
	}
