...
+------------------------------------------------------------------------------
*/
abstract class sw_get_abstract extends sw_abstract
{
	// {{{ members
	...
	public function check_params()
	{
		if (isset($this->__params['limit'])) {
			if (!isset($this->__params['limit']['count'])) {
				throw new sw_exception('limit count required');		
			}	
		...
		if (isset($this->__params['limit_page'])) {
			if (!isset($this->__params['limit_page']['page'])
				...
				throw new sw_exception('limit_page `page` and `rows_count` required');		
			}	
		}
