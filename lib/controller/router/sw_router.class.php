...
use lib\controller\router\sw_abstract;
...
class sw_router extends sw_abstract
{
	 ...
	 * 当前路由 
	 * 
	 * @var \lib\controller\router\route\sw_abstract
	 * @access protected
	 */
	 ...
	 * 
	 * @param string $name 
	 * @param \lib\controller\router\route\sw_abstract $route 
	 * @access public
	 * @return \lib\controller\router\sw_router 
	 */
	public function add_route($name, \lib\controller\router\route\sw_abstract $route)
	{
	 ...
	 * @param string $name 
	 * @access public
	 * @return  \lib\controller\router\route\sw_abstract 
	 */
	 ...
	 */
	public function route(\lib\controller\request\sw_abstract $request)
	{
