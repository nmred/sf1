...
use lib\controller\plugin\sw_broker;
...
class sw_controller
{
	 ...
	 * 路由管理对象 
	 * 
	 * @var \lib\controller\router\sw_abstract
	 * @access protected
	 */
	 ...
	 * 载入的插件列表 
	 * 
	 * @var \lib\controller\plugin\sw_broker
	 * @access protected
	 */
	 ...
	 * 设置分发器 
	 * 
	 * @param \lib\controller\dispatcher\sw_abstract $dispatcher 
	 * @access public
	 * @return \lib\controller\sw_controller
	 */
	public function set_dispatcher(\lib\controller\dispatcher\sw_abstract $dispatcher)
	{
	...
	public function get_dispatcher()
	{
		if (null === $this->__dispatcher) {
			$this->__dispatcher = new \lib\controller\dispatcher\sw_standard();		
		}
	 ...
	 * 注销一个插件 
	 * 
	 * @param string|\lib\controller\plugin\sw_abstract $plugin 
	 * @access public
	 * @return \lib\controller\sw_controller
	 */
	 ...
	 * @param string $class 
	 * @access public
	 * @return false|\lib\controller\plugin\sw_abstract
	 */
	 ...
	 * @access public
	 * @return boolean|\lib\controller\sw_controller
	 */
	 ...
	 * @access public
	 * @return void|\lib\controller\response\sw_abstract
	 */
	public function dispatch(\lib\controller\request\sw_abstract $request = null, \lib\controller\response\sw_abstract $response = null)
	{
		// 初始化请求对象
		if (null !== $request) {
